...
| **M18**| 🟡 P1+P2(3a/3b)+P3 done | Welle 3 + Go-Live | Welle 1+2 production-live (`dpl_3ADeq7…`); Session 31: Datenfluss-Diagramm (`DataFlowDiagram`) + Wortwitz-Eyebrows + ComicStrip-Fix + A11y-Recheck (Lighthouse A11y/BP 100, axe 0 echte Befunde) · offen: Team-Bühnenfotos, 3c Comic-Strip-Erweiterung, Legal/Event-Fotos, Custom-Domain |
