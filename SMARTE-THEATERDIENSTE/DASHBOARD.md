...
| Production-Polish | 🟡 M8 partial — Hosting + Revalidate + M5 live, SEO/OG/Sitemap/Lighthouse offen |
...
**Nichts** — Session 8 (M5 Production-Deploy) beendet. Die Partner-Deutschlandkarte ist jetzt unter `https://smarte-theaterdienste-website.vercel.app/de/beteiligung/mitwirkung` und `/en/participation/contribute` öffentlich erreichbar. Smoke-Test grün: alle 4 Seed-Partner (Bühnenverein, Akademie, Fraunhofer, acatech) im SSG-HTML, alle Routen HTTP 200. Vercel-GitHub-Integration weiterhin offen — Deploys laufen bis zur Dashboard-Verknüpfung per CLI.
...
**Default-Nächster-Schritt: M6 Animation-Polish oder M8-Restpolish** — die Produkt-Funktion ist mit M5 vollständig und production-live, was fehlt ist Feinschliff.
